appStr = new Array();
appStr['fr'] = new Array();
appStr['fr']['metadata-portfolios']="Portfolios";
appStr['fr']['supervisor']="Superviseur";
appStr['fr']['create_user_portfolios']="Créer un usager et ses portfolios";
//----------------------------------------------------
appStr['en'] = new Array();
appStr['en']['metadata-portfolios']="Portfolios";
appStr['en']['supervisor']="Supervisor";
appStr['en']['create_user_portfolios']="Create an user and his portfolios";

//==============================
function specificmenushtml()
//==============================
{
	var html = "";
...
//==============================
{
	...
	//------------------------------
	$("#batch-title-page").html(appStr[LANG]['create_user_portfolios']);
	//------------------------------
...
//==============================
{
	...
	var footer = "<button class='btn' onclick=\""+js2+";\">"+appStr[LANG]['create_user_portfolios']+"</button><button class='btn' onclick=\""+js1+";\">"+karutaStr[LANG]['Cancel']+"</button>";
	$("#edit-window-footer").html(footer);
	$("#edit-window-title").html(appStr[LANG]['create_user_portfolios']);
	$("#edit-window-type").html("");
	g_json = {model_code:"IUT2batch.IUT2_batch_creer_dans_projet",portfolio_code:"IUT2portfolios.IUT2-portfolio",specialite_code:"GEA",diploma_end:"2018",lines:[{superviseur_lastname:"",etudiant_role:"etudiant",superviseur_firstname:"",etudiant_firstname:"",superviseur_email:"",etudiant_lastname:"",superviseur_pwd:"karuta",etudiant_id:"",superviseur_role:"superviseur",superviseur_id:"tuteur",etudiant_email:"",etudiant_pwd:"karuta"}],personnalite_code:"IUT2portfolios.IUT2-TraitsPersonnalite",diploma_begin:"2016",cv_code:"IUT2portfolios.IUT2-cv",profile_code:"IUT2portfolios.IUT2-profile",projet_code:"IUT2portfolios.IUT2-projet"};
	//--------------------------
	...
	batch_attributes['user_divers']=['specialite_code','diploma_begin','diploma_end'];
	...
	batch_attributes['portfolios']=['model_code','portfolio_code','profile_code','cv_code','personnalite_code','projet_code'];
	...
	batch_attributes_val0['user_divers']=['GEA','2016','2018'];
	batch_attributes_val0['supervisor']=['tuteur','','','','karuta','superviseur'];
	batch_attributes_val0['portfolios']=['IUT2batch.IUT2_batch_creer_dans_projet','IUT2portfolios.IUT2-portfolio','IUT2portfolios.IUT2-profile','IUT2portfolios.IUT2-cv','IUT2portfolios.IUT2-TraitsPersonnalite','IUT2portfolios.IUT2-projet'];
	//--------------------------
	var html = "";
	html += "\n			<div role='tabpanel'>";
	...
	html += "\n					<li role='presentation'><a href='#edit-window-body-supervisor' aria-controls='edit-window-body-supervisor' role='tab' data-toggle='tab'>"+appStr[LANG]['supervisor']+"</a></li>";
	html += "\n					<li role='presentation'><a href='#edit-window-body-portfolios' aria-controls='edit-window-body-portfolios' role='tab' data-toggle='tab'>"+appStr[LANG]['metadata-portfolios']+"</a></li>";
	html += "\n				</ul>";
	...
	html +="<hr/>";
	for (var i=0; i<batch_attributes['user_divers'].length; i++){
		js = "g_json."+batch_attributes['user_divers'][i]+"="+"this.value";
		html += getAttributeCreator("form-user",batch_attributes['user_divers'][i],batch_attributes['user_divers'][i],batch_attributes_val0['user_divers'][i],js);
	}
	html += "</form>";
